package io.ooruda.allclimb.user.admin.ticket.error;
...
public enum TicketError implements ResponseCode {
    ...
    UPDATE_ERROR(HttpStatus.BAD_REQUEST, "ticket.error.00003", "ticket update error"),
    DELETE_ERROR(HttpStatus.BAD_REQUEST, "ticket.error.00004", "ticket delete error"),
    ;
